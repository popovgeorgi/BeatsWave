...
namespace BeatsWave.Data.Migrations
{
    ...
    [Migration("20200502102021_addFollowInfoTable")]
    partial class addFollowInfoTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeatsWave.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("FollowInfoId");

                    b.HasIndex("FollowInfoId1");
            ...
            modelBuilder.Entity("BeatsWave.Data.Models.FollowInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BeatsWave.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("BeatsWave.Data.Models.FollowInfo", null)
                        .WithMany("Followers")
                        .HasForeignKey("FollowInfoId");

                    b.HasOne("BeatsWave.Data.Models.FollowInfo", null)
                        .WithMany("Following")
                        .HasForeignKey("FollowInfoId1");
                });
